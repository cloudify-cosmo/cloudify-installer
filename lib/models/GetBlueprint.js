...
var GetBlueprint = function() {
    ...
    function gitCloneByBranch(branch, callback) {
        var exec = childProcess.spawn('git', ['clone', '--branch', branch, 'https://github.com/cloudify-cosmo/cloudify-manager-blueprints']);
    ...
    function gitCloneNightly(callback) {
        var exec = childProcess.spawn('git', ['clone', 'https://github.com/cloudify-cosmo/cloudify-manager-blueprints.git']);
    ...
    function injectBlueprintConf(version, callback) {
        ...
        fs.exists(configFile, function(exists){
            if(!exists) {
                ...
                var exec = childProcess.spawn('cp', [configFile, 'cloudify-manager-blueprints/openstack/openstack.yaml']);
